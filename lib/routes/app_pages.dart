...
class AppPages {
  ...
  static final routes = [
    GetPage(name: RoutePath.kInitial, page: HomePage.new, bindings: [HomeBinding()]),
    GetPage(name: RoutePath.kFavorite, page: FavoritePage.new, bindings: [FavoriteBinding()]),
    GetPage(name: RoutePath.kPopular, page: PopularPage.new, bindings: [PoPopularBinding()]),
    GetPage(name: RoutePath.kAreas, page: AreasPage.new, bindings: [AreasBinding()]),
    GetPage(name: RoutePath.kSettings, page: SettingsPage.new, bindings: [SettingsBinding()]),
    GetPage(name: RoutePath.kHistory, page: HistoryPage.new, bindings: [HistoryPageBinding()]),
    GetPage(name: RoutePath.kSearch, page: SearchRoomPage.new, bindings: [SearchBinding()]),
    ...
    GetPage(name: RoutePath.kSync, page: () => const SyncPage(), bindings: [SyncBinding()]),

    GetPage(name: RoutePath.kAgreementPage, page: () => const AgreementPage(), bindings: [AgreementPageBinding()]),
    // 喜爱分区
